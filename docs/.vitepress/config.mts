...
const enNav = [
  { text: 'Home', link: '/en/' },
  {
    text: 'About',
    items: [
      { text: 'Project', link: '/en/about/' },
      { text: 'Support', link: '/en/about/support' },
      { text: 'Guide', link: '/en/about/guide' }
    ]
  },
  { text: 'GitHub', link: 'https://github.com/ckcsec/wiki-vitepress' }
]

const enSidebar = {
  '/en/about/': [
    {
      text: 'About CKCsec Wiki',
      items: [
        { text: 'Project', link: '/en/about/' },
        { text: 'Support', link: '/en/about/support' },
        { text: 'Guide', link: '/en/about/guide' }
