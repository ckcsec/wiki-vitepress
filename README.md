...
当前项目基于 VitePress 构建，中文站点为默认入口，同时已经建立英文站点镜像。读者可以在中英文之间切换，并保留原有文章结构与页面路径。
...
The project is built with VitePress. Chinese remains the default content source, and the English site mirrors the original article tree so readers can switch languages without losing the current structure or page context.
